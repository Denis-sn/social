...
/**
 * Provides a Node.js 0.8 styles [ReadStream](http://nodejs.org/docs/v0.8.21/api/stream.html#stream_readable_stream) interface for Queries.
 *
 ...
 *
 *
 * The stream interface allows us to simply "plug-in" to other _Node.js 0.8_ styles write streams.
 *
 ...
 *
 * _NOTE: these streams are Node.js 0.8 styles read streams which differ from Node.js 0.10 styles. Node.js 0.10 streams are not well tested yet and are not guaranteed to work._
 *
 * @param {Query} query
